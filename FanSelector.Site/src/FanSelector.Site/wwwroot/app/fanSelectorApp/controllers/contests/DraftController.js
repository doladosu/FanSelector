(function () {
    ...
    var draftController = function ($location, $filter, $window,
        $timeout, authService, dataService, modalService) {
    ...
    draftController.$inject = injectParams;

    angular.module('fanSelectorApp').controller('DraftController', draftController);
